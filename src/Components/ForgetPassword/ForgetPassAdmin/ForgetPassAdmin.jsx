    ...
    return (
        <div className='forget'>
            <form onSubmit={handleForget} className='forget_text' >
                ...
                <div className='forget_back pointer' onClick={() => { navigate('/login/loginadmin') }} ><MdOutlineArrowBack fontSize={20} /><p>Back to login</p></div>
            </form>
...
export default ForgetPasswordAmin